...
export const SearchPanel = ({
  ...
  const handleWorkerUpdate = () => {
    const x = Math.max(0, Math.min(29, parseInt(workerX) || 0));
    const y = Math.max(0, Math.min(29, parseInt(workerY) || 0));
    ...
    <div className="sidebar-panel" data-testid="search-panel">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div>
            ...
            <Input
              ...
              className="input-industrial h-9"
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          ...
          <Select value={selectedType} onValueChange={setSelectedType}>
            <SelectTrigger className="input-industrial" data-testid="type-filter">
        ...
        <div className="space-y-2">
          ...
          <Select value={selectedGrade} onValueChange={setSelectedGrade}>
            <SelectTrigger className="input-industrial" data-testid="grade-filter">
        ...
        <div className="space-y-2">
          ...
          <Select value={selectedSize} onValueChange={setSelectedSize}>
            <SelectTrigger className="input-industrial" data-testid="size-filter">
      ...
      <div className="space-y-3">
        ...
        <Button
          ...
          className="w-full btn-secondary h-9"
